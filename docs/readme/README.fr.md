...
- Suivez **Save → Test → Select**. Save et Test n'autorisent pas le texte des sous-titres ; avant Select, seule une liste de modèles sans sous-titres peut atteindre l'endpoint.
