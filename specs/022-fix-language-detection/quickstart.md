...
4. 依次加载罗马字日语、自然豪萨语和混合字幕：目标不等价时有候选应进入翻译；豪萨语须识别正确；混合主语言应为清单中占比最高的范围内语言，包含芬兰语 60%、英语 25%、德语 15% 时识别英语的样本。把目标改成所选范围内主语言，确认无需翻译且本地 Provider 无新增翻译请求；中文及地区变体按既有等价规则核对。
